              ...
              {profileMenuOpen && (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-2 text-[13px] font-extrabold text-emerald-600 hover:bg-emerald-50 transition-colors text-left cursor-pointer"
                  >
